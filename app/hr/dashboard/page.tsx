    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <nav className="w-full h-16 border-b-[4px] border-black flex items-center justify-between px-8 bg-white sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={handleLogout} className="bg-black text-white font-black py-2 px-4 border-[3px] border-black hover:bg-zinc-800 transition-all text-sm active:translate-x-[2px] active:translate-y-[2px]">
            Logout
          </button>
        </div>
      </nav>
                  ...
                  <div className="flex flex-col lg:flex-row justify-between gap-8">
                    <div className="flex-1">
                      ...
                      <div className="flex gap-4">
                        <button 
                          onClick={() => {
                            const blob = new Blob([app.tailored_resume], { type: 'text/markdown' });
                            const url = URL.createObjectURL(blob);
                            const link = document.createElement('a');
                            link.href = url;
                            link.download = `Resume_${app.applicant_name}_${app.job_title}.md`;
                            link.click();
                          }}
